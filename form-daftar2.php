    ...
    <form action="proses-pendaftaran2.php" method="POST">
      ...
      <div class="mb-3">
        <div class="form-check">
          ...
          <input class="form-check-input" type="radio" name="jk" <?php if ($jk == 'laki-laki') {
            echo "checked";
          } ?>
            value="laki-laki">
          ...
          <input class="form-check-input" type="radio" name="jk" <?php if ($jk == 'perempuan') {
            echo "checked";
          } ?>
            value="perempuan">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" name="no_tel" value="<?php echo $no_tel; ?>"
