  ...
  <div class="container mt-4">
    ...
    <form action="proses.php" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" name="tanggal_lahir" value="<?php echo $tl; ?>"
      ...
      <div class="mb-3">
        ...
        <select name="kota" class="form-control">
          <option <?php if ($kota == 'kabupaten bandung') {
            echo "selected";
          } ?> value="kabupaten bandung">Kota Bandung
          </option>
          <option <?php if ($kota == 'kab.bandung') {
            echo "selected";
          } ?> value="kab.bandung">>Kab. Bandung</option>
          <option <?php if ($kota == 'kota cimahi') {
            echo "selected";
          } ?> value="kota cimahi">>Kota Cimahi</option>
          <option <?php if ($kota == 'kab. bandung barat') {
            echo "selected";
          } ?> value="kab. bandung barat">>Kab.
            Bandung
            Barat</option>
          <option <?php if ($kota == 'kab.sumedang') {
            echo "selected";
          } ?> value="kab.sumedang">>Kab. Sumedang</option>
        </select>
      </div>
      <div class="mb-3">
        <label for="provinsi" class="form-label">Provinsi</label>
        <select name="provinsi" class="form-control">
          <option <?php if ($provinsi == 'Banten') {
            echo "selected";
          } ?> value="Banten">Banten</option>
          <option <?php if ($provinsi == 'DKI Jakarta') {
            echo "selected";
          } ?> value="DKI Jakarta">DKI Jakarta</option>
          <option <?php if ($provinsi == 'Jawa Barat') {
            echo "selected";
          } ?> value="Jawa Barat">Jawa Barat</option>
          <option <?php if ($provinsi == 'Jawa Tengah') {
            echo "selected";
          } ?> value="Jawa Tengah">Jawa Tengah</option>
          <option <?php if ($provinsi == 'Jawa Timur') {
            echo "selected";
          } ?> value="Jawa Timur">Jawa Timur</option>
          <option <?php if ($provinsi == 'DIY Yogyakarta') {
            echo "selected";
          } ?> value="DIY Yogyakarta">DIY Yogyakarta
          </option>
        </select>
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <div class="form-check">
          ...
          <input class="form-check-input" type="radio" name="jenis_kelamin" <?php if ($jk == 'laki-laki') {
            echo "checked";
          } ?> value="laki-laki">
          <label class="form-check-label" for="laki-laki">Laki-Laki</label><br>
          <input class="form-check-input" type="radio" name="jenis_kelamin" <?php if ($jk == 'perempuan') {
            echo "checked";
          } ?> value="perempuan">
